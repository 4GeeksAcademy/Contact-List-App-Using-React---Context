...
export default function useGlobalReducer() {
    const { dispatch, store, goGetAgenda, createContact, getContacts, deleteContact } = useContext(StoreContext)
    return { dispatch, store, goGetAgenda, createContact, getContacts, deleteContact };
}